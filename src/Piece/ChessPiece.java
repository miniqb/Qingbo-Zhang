...
public class ChessPiece implements Piece{
    ...
    public ChessPiece(String name,byte ID,Point pos) {
        ...
        switch (name) {
            case P_BING_HAN -> {
                this.image = pieces_images[0];
                this.group = Judge.G_HAN;
            }
            case P_CHE_HAN -> {
                this.image = pieces_images[1];
                this.group = Judge.G_HAN;
            }
            case P_JIANG_CHU -> {
                this.image = pieces_images[2];
                this.group = Judge.G_CHU;
            }
            case P_JU_CHU -> {
                this.image = pieces_images[3];
                this.group = Judge.G_CHU;
            }
            case P_MA_CHU -> {
                this.image = pieces_images[4];
                this.group = Judge.G_CHU;
            }
            case P_MA_HAN -> {
                this.image = pieces_images[5];
                this.group = Judge.G_HAN;
            }
            case P_PAO_CHU -> {
                this.image = pieces_images[6];
                this.group = Judge.G_CHU;
            }
            case P_PAO_HAN -> {
                this.image = pieces_images[7];
                this.group = Judge.G_HAN;
            }
            case P_SHI_CHU -> {
                this.image = pieces_images[8];
                this.group = Judge.G_CHU;
            }
            case P_SHI_HAN -> {
                this.image = pieces_images[9];
                this.group = Judge.G_HAN;
            }
            case P_SHUAI_HAN -> {
                this.image = pieces_images[10];
                this.group = Judge.G_HAN;
            }
            case P_XIANG_CHU -> {
                this.image = pieces_images[11];
                this.group = Judge.G_CHU;
            }
            case P_XIANG_HAN -> {
                this.image = pieces_images[12];
                this.group = Judge.G_HAN;
            }
            case P_ZU_CHU -> {
                this.image = pieces_images[13];
                this.group = Judge.G_CHU;
            }
            default -> {
                this.image = null;
